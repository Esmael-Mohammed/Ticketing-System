...
export default class Signup extends Component {
    state = { username: "", email: "", password: "", role: "user", redirect: false };
  ...
  render() {
    ...
    return (
        ...
        <form onSubmit={this.handleSubmit}>
          <input type="text" className="w-full p-2 border" placeholder="Username" onChange={(e) => this.setState({ username: e.target.value })} />
